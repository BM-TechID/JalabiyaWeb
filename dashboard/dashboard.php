                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-info text-light">
                                                <div class="stat-panel text-center">
                                                    <?php
                                                    $sqlbayar = "SELECT kode_booking FROM peminjaman WHERE status='Menunggu Pembayaran'";
                                                    $querybayar = mysqli_query($connection, $sqlbayar);
                                    ...
                                    <div class="col-md-4">
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-success text-light">
                                                <div class="stat-panel text-center">
                                                    <?php
                                                    $sqlkonfir = "SELECT kode_booking FROM peminjaman WHERE status='Menunggu Konfirmasi'";
                                                    $querykonfir = mysqli_query($connection, $sqlkonfir);
                                    ...
                                    <div class="col-md-4">
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-info text-light">
                                                <div class="stat-panel text-center">
                                                    <?php
                                                    $sqlbelum = "SELECT kode_booking FROM peminjaman WHERE status='Sudah Dibayar'";
                                                    $querybelum = mysqli_query($connection, $sqlbelum);
                                    ...
                                    <div class="col-md-4">
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-warning text-light">
                                                <div class="stat-panel text-center">
                                                    <?php
                                                    $sql2 = "SELECT kode_booking FROM peminjaman";
